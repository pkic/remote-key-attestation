...
* Issuing code signing certificates for customer keys in customer’s HSM, verifying that the subscribers private signature key is generated and managed in an approved cryptographic device.
...
# Standards
--------
There are a few standardizaton efforts avaialable. Known effors:
...
# Implementations
-----
This table lists known hardware cryptographic devices and their support, or non-support, for remote key attestation.
